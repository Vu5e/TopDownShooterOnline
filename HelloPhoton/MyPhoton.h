...
public:
	...
	void sendMyData(Spaceship mySpaceship, Bullet* myBulletsArray[100], int myBulletsCount);
	void sendMyShot(int playerID, float command, Vector target);
	void sendDamageNotify(int playerID, int damage);
	void sendMyMissile(int playerID, float command, Vector target); //New addition
